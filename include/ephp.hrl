...
-define(IS_CALLABLE(C),
        erlang:'or'(?IS_FUNCTION(A),
                    erlang:'or'(?IS_ARRAY(A), erlang:'or'(is_binary(A), ?IS_OBJECT(A))))).
...
-record(int, {int :: integer(), line :: line()}).
-record(float, {float :: float() | nan | infinity, line :: line()}).
...
-type mixed() ::
    ...
    resource().
-type var_value() ::
    {variable() | constant() | text() | text_to_process() | mixed(), mixed()}.
...
-record(eval, {statements :: statements(), line :: line()}).
-record(print, {expression :: expression(), line :: line()}).
-record(print_text, {text :: binary(), line :: line()}).
...
-record(foreach,
        {kiter :: variable() | undefined,
         ...
         line :: line()}).
-record(switch_case,
        {label :: default | mixed(), code_block :: statements(), line :: line()}).

-type switch_case() :: #switch_case{}.
-type switch_cases() :: [switch_case()].

-record(switch, {condition :: condition(), cases :: switch_cases(), line :: line()}).
...
-record(return, {value :: mixed(), line :: line()}).

-type return() :: #return{}.

-record(throw, {value :: mixed(), line :: line()}).

-type throw() :: #throw{}.

-record(global, {vars :: [variable()], line :: line()}).

-type global() :: #global{}.

-record(text, {text :: binary(), line :: line()}).

-type text() :: #text{}.

-record(text_to_process,
        {text :: [expression() | variable() | binary()], line :: line()}).

-type text_to_process() :: #text_to_process{}.

-record(command, {text :: [expression() | variable() | binary()], line :: line()}).
...
-record(array_element,
        {idx = auto :: auto | expression(), element :: expression(), line :: line()}).

-type array_element() :: #array_element{}.

-record(array, {elements = [] :: [array_element()], line :: line()}).
...
-record(ref, {var :: variable(), line :: line()}).

-type ref() :: #ref{}.

-record(concat, {texts :: [any()], line :: line()}).

% variable values (ephp_vars)

-record(var_value, {content :: any()}).
-record(var_ref,
        {pid :: ephp:context_id() | undefined, ref :: #variable{} | global | undefined}).

-type var_ref() :: #var_ref{}.

-record(obj_ref, {pid :: ephp:objects_id(), ref :: object_id()}).

-type obj_ref() :: #obj_ref{}.
-type object_id() :: pos_integer().

-record(mem_ref, {mem_id :: mem_id()}).

-type mem_ref() :: #mem_ref{}.
-type mem_id() :: pos_integer().

-record(resource, {id :: pos_integer(), pid :: any(), module :: module()}).

-type resource() :: #resource{}.

% classes

-record(class_const, {name :: binary(), value :: mixed(), line :: line()}).
...
-record(clone, {var :: variable(), line :: line()}).
...
-record(catch_block,
        {exception :: variable(), code_block :: statements(), line :: line()}).
