...
### <a name="type-alias_class">alias_class()</a> ###


<pre><code>
alias_class() = {alias, <a href="#type-namespace">namespace()</a>, <a href="#type-class_name">class_name()</a>}
</code></pre>
...
<pre><code>
set_alias(Ref::<a href="ephp.md#type-classes_id">ephp:classes_id()</a>, NS::<a href="#type-namespace">namespace()</a>, ClassName::<a href="#type-class_name">class_name()</a>, NSAlias::<a href="#type-namespace">namespace()</a>, Alias::<a href="#type-alias_class">alias_class()</a>) -&gt; <a href="#type-alias_return">alias_return()</a>
</code></pre>
<br />
