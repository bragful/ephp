...
-export([get_classes/0, get_trace/1, get_message/1, exception_construct/4,
         exception_get_message/3, exception_get_code/3, exception_get_file/3, exception_get_line/3,
         exception_get_trace/3, exception_get_previous/3, exception_get_trace_as_string/3,
...
exception_construct(Ctx,
    ...
    ephp_context:set_bulk(ClassCtx,
                          [{#variable{name = <<"message">>}, Message},
